...
utilizes ES6 imports that allows you to include only the icons that your project
is using.
...
usage examples and how to use icons from other packages. _NOTE_: each Icon
package has it's own subfolder under `react-icons` you import from.
...
If your project grows in size, this option is available. This method has the
trade-off that it takes a long time to install the package.
...
| | [HealthIcons](https://github.com/labordude/healthicons) |
[MIT](https://opensource.org/licenses/MIT) |
96808010df91059f086305dba509d04c617fc385 | 1953 |
...
From version 3, `vertical-align: middle` is not automatically given. Please use
IconContext to specify className or specify an inline style.
...
`./build-script.sh` will build the whole project. See also CI scripts for more
information.
...
> **Note** The project is not actively accepting PR for the preview site at this
> time.

The preview site is the
[`react-icons`](https://react-icons.github.io/react-icons/) website, built in
Astro+React.
...
The demo is a [Create React App](https://create-react-app.dev/) boilerplate with
...
SVG is [supported by all major browsers](http://caniuse.com/#search=svg). With
`react-icons`, you can serve only the needed icons instead of one big font file
to the users, helping you to recognize which icons are used in your project.
